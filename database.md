...
За замовчуванням зразок Laravel[конфігурація середовища](/docs/{{version}}/configuration#environment-configuration)готовий до використання з[Садиба Laravel](/docs/{{version}}/homestead), яка є зручною віртуальною машиною для розробки Laravel на вашій локальній машині. Ви можете змінювати цю конфігурацію відповідно до вашої локальної бази даних.
